...
mongoose.model('OAuthAccessTokens', OAuthAccessTokenSchema);
mongoose.model('OAuthRefreshTokens', OAuthRefreshTokenSchema);
mongoose.model('OAuthClients', OAuthClientSchema);
mongoose.model('OAuthUsers', OAuthUserSchema);
...
// This will very much depend on your setup, I wouldn't advice doing anthing exactly like this but
